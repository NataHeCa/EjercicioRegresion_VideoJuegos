# -*- coding: utf-8 -*-
"""Despliegue_Videojuegos_con_streamlit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1rfRjau5plYA1x4SxkS1I2bNS_Z7n1N_z
...
Edad = st.slider('Edad', min_value=14, max_value=52, value=20, step=1) #Se registra la cantidad maxi y minima de la variable
videojuego = st.selectbox('Videojuego', ["'Mass Effect'","'Battlefield'", "'Fifa'","'KOA: Reckoning'","'Crysis'","'Sim City'","'Dead Space'","'F1'"]) #Poner todas las categorias
Plataforma = st.selectbox('Plataforma', ["'Play Station'", "'Xbox'","PC","Otros"])#poner todas las categorias
Sexo = st.selectbox('Sexo', ['Hombre', 'Mujer'])
Consumidor_habitual = st.selectbox('Consumidor_habitual', ['True', 'False'])
#Los datos deben tener la misma estructura en todo el codigo
